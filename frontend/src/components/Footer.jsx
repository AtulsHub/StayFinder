...
const Footer = () => {
  return (
    <>
      <footer className=" border-t pt-10 px-6 md:px-16 text-sm text-gray-600 bg-gray-100">
        <div className="max-w-full mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 py-4">
          <div>
